...
class DogTest {
    ...
    void die() {
        Dog barlow = new Dog();
        barlow.die();
        String expected = "Dog{name='Felix', isDead=true}";
        String actual = barlow.toString();
        assertTrue(expected.equals(actual),"Expected:\n"+expected+"\n\nActual:\n"+actual);
        Dog panda = new Dog();
        panda.die();
        expected = "Dog{name='Felix', isDead=true}";
        actual = panda.toString();
        assertTrue(expected.equals(actual),"Expected:\n"+expected+"\n\nActual:\n"+actual);
    }
}